...
export const data = new SlashCommandBuilder()
    .setName('loop')
    .setDescription('Loop current audio');
...
export async function execute(interaction) {
    ...
    await interaction.editReply({
        embeds: [make_simple_embed(client.streams[interaction.guildId].loop ? "Loop successfully **enabled** for current audio" : "Loop successfully **disabled** for current audio")],
