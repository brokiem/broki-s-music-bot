...
export const data = new SlashCommandBuilder()
    .setName('control')
    .setDescription('Control current audio');
...
export async function execute(interaction) {
    ...
    await interaction.editReply({
        embeds: [make_playing_embed(interaction.guildId, interaction.member, null, stream_data.yt_title, stream_data.yt_url, stream_data.yt_thumbnail_url, true)],
